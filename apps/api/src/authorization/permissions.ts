...
export const rolePermissions: Record<OrganizationRole, ReadonlySet<Permission>> = {
  ...
  CONTRACT_MANAGER: new Set(['organization.read','membership.read','department.read','contract.request.create','contract.request.read','contract.request.triage','contract.read','contract.manage','contract.review','contract.activate','document.read','document.upload','document.manage','library.read','library.manage','operations.read','operations.manage','renewal.manage','report.read']),
