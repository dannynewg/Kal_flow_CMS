...
export const rolePermissions: Record<OrganizationRole, ReadonlySet<Permission>> = {
  ...
  CONTRACT_MANAGER: new Set(['organization.read','membership.read','department.read','contract.request.create','contract.request.read','contract.request.triage','contract.read','contract.manage','contract.review','contract.activate','library.read','library.manage','operations.read','operations.manage','renewal.manage','report.read']),
  LEGAL_OFFICER: new Set(['organization.read','membership.read','department.read','contract.request.create','contract.request.read','contract.read','contract.review','document.read','document.upload','library.read','library.manage','operations.read','renewal.manage','report.read']),
  ...
  CONTRACT_OWNER: new Set(['organization.read','department.read','contract.request.create','contract.request.read','contract.read','contract.manage','document.read','document.upload','library.read','operations.read','operations.manage','renewal.manage']),
  AUDITOR: new Set(['organization.read','membership.read','department.read','invitation.read','audit.read','contract.request.read','contract.read','document.read','library.read','operations.read','report.read']),
